...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--datadir", help="Input data directory containing scandir jsons")
    parser.add_argument("-f", "--funclist", help="Input directory containing catalyst functionalization lists")
    args = parser.parse_args()

    for funclist_filename in os.listdir(args.f):
        funclist_filepath = args.f + '/' + funclist_filename
    ...
    for infile in os.listdir(args.d):
        ...
        scandir_analysis.parse_autoq_catalysts(df)
